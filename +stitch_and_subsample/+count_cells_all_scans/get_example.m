function [stitch_cropped, cells_algorithm1, cells_algorithm2] = get_example(stitch)
    ...
    cells_algorithm1 = stitch_and_subsample.count_cells_all_scans.count_cells_in_scan(stitch_cropped, gaussian_sigma);
    
    %Run the adaptiveThreshold algorithm for identifying cells:
    cells_algorithm2 = stitch_and_subsample.count_cells_all_scans.count_cells_in_scan_adaptThresh(stitch_cropped, sensitivity, minNucleusSize, scaleOption);
