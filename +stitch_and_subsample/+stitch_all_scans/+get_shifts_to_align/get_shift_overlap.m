function [shift_column, shift_row] = get_shift_overlap(folder, name_scan)
    ...
    % that distance):
    % DLS removed since by entering the 10% figure, you are not doubling this number
    overlap_column_x = overlap_column_x;
    overlap_column_y = overlap_column_y;
    overlap_row_x = overlap_row_x;
    overlap_row_y = overlap_row_y;
