function stitch_info = create_structure_to_store_stitch_info(paths)
    ...
    for i = 1:num_folders
        ...
        list_scan_names = {'.tif'}; % I changed here since I just need this to work for a single scan
        ...
        for j = 1:num_scans
            ...
            list_image_names_scan = stitch_and_subsample.utilities.get_structure_results_containing_string(list_image_names, 'name', name_scan);
            ...
            list_wavelengths = unique(regexp(list_wavelengths,{'([a-zA-Z]*)'},'match', 'once')); % finds the channels you have
            ...
            for k = 1:num_wavelengths
                ...
                list_images = ...
                    stitch_and_subsample.utilities.get_structure_results_containing_string(...
