function stitch_info = get_stitch_coordinates(stitch_info)
    ...
    for i = 1:numel(stitch_info)
        ...
        for j = 1:numel(stitch_info(i).scan_info)
            ...
            stitch_info(i).scan_info(j).stitch_coords = stitch_and_subsample.stitch_all_scans.get_stitch_coordinates.create_structure_to_store_coords(stitch_info(i).scan_info(j));
            ...
            stitch_info(i).scan_info(j) = stitch_and_subsample.stitch_all_scans.get_stitch_coordinates.get_shift_for_each_position(stitch_info(i).scan_info(j));
            ...
            stitch_info(i).scan_info(j) = stitch_and_subsample.stitch_all_scans.get_stitch_coordinates.get_coords_for_each_position(stitch_info(i).scan_info(j));
            ...
            stitch_info(i).scan_info(j) = stitch_and_subsample.stitch_all_scans.get_stitch_coordinates.get_overlap_for_each_position(stitch_info(i).scan_info(j));
