function stitch_coords = create_structure_to_store_coords(scan)
    ...
    matrix_of_positions = reshape(1:scan.num_tiles_row*scan.num_tiles_column, [scan.num_tiles_row,scan.num_tiles_column])';
    matrix_of_positions(2:2:end,:) = fliplr(matrix_of_positions(2:2:end,:));
    % Changed to be compatible with snake input
    ...
    for i = 1:num_positions
        ...
        % save the row and column numbers:
