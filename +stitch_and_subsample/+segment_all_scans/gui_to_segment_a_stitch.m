function boundaries = gui_to_segment_a_stitch(stitch, boundaries, instructions)
    ...
    function callback_add(~, ~)
        ...
        % save coords:
        boundaries = stitch_and_subsample.utilities.add_entry_to_structure(temp, boundaries);
    ...
    function callback_done(~,~)
        ...
        boundaries = stitch_and_subsample.utilities.get_structure_results_matching_string(boundaries, 'status', 'keep');
