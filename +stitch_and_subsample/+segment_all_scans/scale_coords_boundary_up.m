...
function boundaries_original = scale_coords_boundary(boundaries, scale_rows, scale_columns)
    ...
    for i = 1:num_boundaries
        ...
        % scale coords:
        coordinates_mask_original = stitch_and_subsample.utilities.scale_coords(coordinates_mask, scale_rows, scale_columns);
        coordinates_boundary_original = stitch_and_subsample.utilities.scale_coords(coordinates_boundary, scale_rows, scale_columns);
