        ...
        for j = 1:numel(list_stitch_info)
            ...
            % if the boundaries file does not already exist:
                ...
                for k=1:nGroups
                    ...
                    boundaries.(groups{k}).colonies.stitch_small = stitch_and_subsample.segment_all_scans.gui_to_segment_a_stitch(stitch_small, boundaries.(groups{k}).colonies.stitch_small, instructions_colonies);
                    ...
                    boundaries = stitch_and_subsample.segment_all_scans.scale_coords_boundary_up_multichanel(boundaries, groups{k}, stitch_info.scale_rows, stitch_info.scale_columns);
                    ...
                    cells.(groups{k}).colonies = stitch_and_subsample.segment_all_scans.get_cells_within_boundaries(cells.all, boundaries.(groups{k}).colonies);
                ...
                % overlay on stitch:
                stitch_small_annotated = stitch_and_subsample.segment_all_scans.overlay_on_image_multichannel(stitch_small, cells, groups);
